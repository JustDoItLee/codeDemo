...
public class FastJsonUtils {
    ...
    public static Map<String, Object> toMap(final String jsonStr) {
        ...
        try {
            ...
            log.error(String.format("converte json string to Map<String,Object> failed:%s", e.getMessage()));
        }
        return map;
    }
    ...
    public static Map<String, String> toMapS(final String jsonStr) {
        ...
        try {
            ...
            log.error(String.format("converte json string to Map<String,String> failed:%s", e.getMessage()));
        }
        return map;
    }
    ...
    public static <T> T toBean(final String jsonStr, Class<T> clazz) {
        ...
        try {
            ...
            log.error(String.format("converte json string to <%s> failed:<%s>", clazz.getName(), e.getMessage()));
        }
        return t;
    }
    ...
    public static <T> List<T> toBeanList(final String jsonStr, Class<T> clazz) {
        ...
        try {
            ...
            log.error(String.format("converte json string to List<%s> failed:%s", clazz.getName(), e.getMessage()));
        }
        return list;
    }
